...
import { useGammaProducts, useCollections } from '@/hooks/useGammaProducts';
...
export function CollectionsDialog({ open, onOpenChange }: CollectionsDialogProps) {
  ...
  const { data: products } = useGammaProducts(100);
                ...
                return (
                  <li key={event.id} className="flex items-center justify-between gap-2 p-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">{parsed.products.length} product(s)</p>
                    </div>
        ...
        <div className="space-y-4 rounded-md border p-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Original Paintings"
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            {products && products.length > 0 ? (
              ...
              <p className="text-sm text-muted-foreground">No products to add yet.</p>
            )}
          </div>
